...
!!
!!   $HeadURL: svn://fcm2/JULES_svn/JULES/trunk/src/control/standalone/var/model_time_mod.F90 $
!!   $Author: hadmq $
!!
...
! Module variables
!-----------------------------------------------------------------------------
  TYPE(datetime) :: run_min_time, run_max_time  ! The start and end time for
                                                ! the run
  ...
  INTEGER :: timestep_len  ! The length of the model timestep
